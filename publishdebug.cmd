...
dotnet publish -c Debug /p:Platform="Any CPU" -r linux-arm --framework net6.0 --self-contained true /p:PublishTrimmed=true -o ./publish/conformu.linux-arm32
bsdtar -cJf publish/conformu.linux-arm32.tar.xz -C publish\conformu.linux-arm32 *
rmdir /s /q "publish/conformu.linux-arm32"

dotnet publish -c Debug /p:Platform="Any CPU" -r linux-arm64 --framework net6.0 --self-contained true /p:PublishTrimmed=true -o ./publish/conformu.linux-aarch64
...
dotnet publish -c Debug /p:Platform="Any CPU" -r linux-x64 --framework net6.0 --self-contained true /p:PublishTrimmed=true -o ./publish/conformu.linux-x64
...
dotnet publish -c Debug /p:Platform="Any CPU" -r osx-x64 --framework net6.0 --self-contained true /p:AppImage=true /p:PublishTrimmed=true -o ./publish/conformu.macos-x64

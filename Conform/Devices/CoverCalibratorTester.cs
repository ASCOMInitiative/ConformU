    ...
    internal class CoverCalibratorTester : DeviceTesterBaseClass
    {
            ...
            try
            {
                switch (settings.DeviceTechnology)
                {
                    case DeviceTechnology.Alpaca:
                        ...
                        coverCalibratorDevice = new AlpacaCoverCalibrator(settings.AlpacaConfiguration.AccessServiceType.ToString(), settings.AlpacaDevice.IpAddress, settings.AlpacaDevice.IpPort, settings.AlpacaDevice.AlpacaDeviceNumber, settings.AlpacaConfiguration.LogCalls ? logger : null);
        ...
        public override void CheckProperties()
        {
            ...
            if (calibratorStateOk)
            {
                ...
                try
                {
                    ...
                    if (settings.DisplayMethodCalls)
                        LogMsg("MaxBrightness", MessageLevel.msgComment, "About to call MaxBrightness property");
                    ...
                    if (!(coverCalibratorDevice.CalibratorState == CalibratorStatus.NotPresent))
                    {
                        if (maxBrightness >= 1)
                        {
                            LogMsg("MaxBrightness", MessageLevel.msgOK, maxBrightness.ToString());
            ...
            if (calibratorStateOk)
            {
                ...
                {
                    if (settings.DisplayMethodCalls)
                        LogMsg("Brightness", MessageLevel.msgComment, "About to call Brightness property");
                        ...
                        if (brightness >= 0)
                        {
                            if (maxBrightnessOk)
                            {
                                if (brightness <= maxBrightness)
                                    LogMsg("Brightness", MessageLevel.msgOK, maxBrightness.ToString());
                                else
        ...
        public override void CheckMethods()
        {
            ...
            if (coverStateOk)
            {
                ...
                {
                    if (settings.DisplayMethodCalls)
                        LogMsg("OpenCover", MessageLevel.msgComment, "About to call OpenCover method");
            ...
            if (coverStateOk)
            {
                ...
                {
                    if (settings.DisplayMethodCalls)
                        LogMsg("CloseCover", MessageLevel.msgComment, "About to call CloseCover method");
                    startTime = DateTime.Now;
                ...
                if (!(coverState == CoverStatus.NotPresent))
                {
                    if (canAsynchronousOpen)
                    {
                        if ((asynchronousOpenTime > 0.0) & (asynchronousCloseTime > 0.0))
                        {
                            ...
                            if (settings.DisplayMethodCalls)
                                LogMsg("HaltCover", MessageLevel.msgComment, "About to call OpenCover method");
                            coverCalibratorDevice.OpenCover();
                            ...
                            if (coverCalibratorDevice.CoverState == CoverStatus.Moving)
                            {
                                try
                                {
                                    ...
                                    if (settings.DisplayMethodCalls)
                                        LogMsg("HaltCover", MessageLevel.msgComment, "About to call HaltCover method");
            ...
            if (calibratorStateOk)
            {
                if (!(calibratorState == CalibratorStatus.NotPresent))
                {
                    try
                    {
                        ...
                        if (settings.DisplayMethodCalls)
                            LogMsg("CalibratorOff", MessageLevel.msgComment, "About to call CalibratorOff method");
                        ...
                        if (!(coverCalibratorDevice.CalibratorState == CalibratorStatus.NotReady))
                        {
                            if (coverCalibratorDevice.CalibratorState == CalibratorStatus.Off)
                            {
                                ...
                                if (settings.DisplayMethodCalls)
                                    LogMsg("CalibratorOff", MessageLevel.msgComment, "About to call Brightness property");
        ...
        private void TestCalibratorOn(int requestedBrightness)
        {
            ...
            if (!(calibratorState == CalibratorStatus.NotPresent))
            {
                try
                {
                    ...
                    if (settings.DisplayMethodCalls)
                        LogMsg("CalibratorOn", MessageLevel.msgComment, $"About to call CalibratorOn method with brightness: {requestedBrightness}");
                    ...
                    if (!(coverCalibratorDevice.CalibratorState == CalibratorStatus.NotReady))
                    {
                        ...
                        else if (coverCalibratorDevice.CalibratorState == CalibratorStatus.Ready)
                        {
                            ...
                            if (settings.DisplayMethodCalls)
                                LogMsg("CalibratorOn", MessageLevel.msgComment, $"About to call Brightness property.");
            ...
            try
            {
                ...
                switch (propertyToTest)
                {
                    case RequiredProperty.CalibratorState:
                        {
                            if (settings.DisplayMethodCalls)
                                LogMsg("CalibratorState", MessageLevel.msgComment, "About to call CalibratorState property");
                    ...
                    case RequiredProperty.CoverState:
                        {
                            if (settings.DisplayMethodCalls)
                                LogMsg("CoverState", MessageLevel.msgComment, "About to call CoverState property");

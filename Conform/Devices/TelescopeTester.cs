    ...
    internal class TelescopeTester : DeviceTesterBaseClass, IDisposable
    {
            ...
            try
            {
                switch (settings.DeviceTechnology)
                {
                    case DeviceTechnology.Alpaca:
                        ...
                        telescopeDevice = new AlpacaTelescope(settings.AlpacaConfiguration.AccessServiceType.ToString(), settings.AlpacaDevice.IpAddress, settings.AlpacaDevice.IpPort, settings.AlpacaDevice.AlpacaDeviceNumber, settings.AlpacaConfiguration.LogCalls ? logger : null);
        ...
        public override void PreRunCheck()
        {
            ...
            if (!cancellationToken.IsCancellationRequested)
            {
                ...
                {
                    LogMsg("TimeCheck", MessageLevel.msgError, $"Exception reading PC Time: {ex}");
                }

                // v1.0.12.0 Added catch logic for any UTCDate issues
                try
                {
                    if (settings.DisplayMethodCalls) LogMsg("TimeCheck", MessageLevel.msgComment, "About to get UTCDate property");
                    ...
                    LogMsg("TimeCheck", MessageLevel.msgInfo, $"Mount UTCDate: {telescopeDevice.UTCDate:dd-MMM-yyyy HH:mm:ss.fff}");
                }
                catch (COMException ex)
                {
                    ...
                    {
                        LogMsg("TimeCheck", MessageLevel.msgError, "Mount UTCDate: COM Exception - " + ex.ToString());
                    }
                }
        ...
        public override void CheckProperties()
        {
            ...
            try
            {
                ...
                switch (m_Altitude)
                {
                    case var @case when @case < 0.0d:
                        {
                            LogMsg("Altitude", MessageLevel.msgWarning, "Altitude is <0.0 degrees: " + m_Altitude.ToString("0.00000000"));
                            break;
                        }

                    case var case1 when case1 > 90.0000001d:
                        {
                            LogMsg("Altitude", MessageLevel.msgWarning, "Altitude is >90.0 degrees: " + m_Altitude.ToString("0.00000000"));
                            break;
                        }

                    default:
                        {
                            LogMsg("Altitude", MessageLevel.msgOK, m_Altitude.ToString("0.00"));
                            break;
                        }
                }
            }
            ...
            try
            {
                ...
                switch (m_Azimuth)
                {
                    case var case4 when case4 < 0.0d:
                        {
                            LogMsg("Azimuth", MessageLevel.msgWarning, "Azimuth is <0.0 degrees: " + m_Azimuth.ToString("0.00"));
                            break;
                        }

                    case var case5 when case5 > 360.0000000001d:
                        {
                            LogMsg("Azimuth", MessageLevel.msgWarning, "Azimuth is >360.0 degrees: " + m_Azimuth.ToString("0.00"));
                            break;
                        }

                    default:
                        {
                            LogMsg("Azimuth", MessageLevel.msgOK, m_Azimuth.ToString("0.00"));
                            break;
                        }
                }
            }
            ...
            try
            {
                ...
                if (canSetDeclinationRate) // Any value is acceptable
                {
                    switch (m_DeclinationRate)
                    {
                        case var case8 when case8 >= 0.0d:
                            {
                                LogMsg("DeclinationRate Read", MessageLevel.msgOK, m_DeclinationRate.ToString("0.00"));
                                break;
                            }

                        default:
                            {
                                LogMsg("DeclinationRate Read", MessageLevel.msgWarning, "Negative DeclinatioRate: " + m_DeclinationRate.ToString("0.00"));
                                break;
                            }
                    }
                }
                else // Only zero is acceptable
                {
                    switch (m_DeclinationRate)
                    {
                        ...
                        default:
                            {
                                LogMsg("DeclinationRate Read", MessageLevel.msgIssue, "DeclinationRate is non zero when CanSetDeclinationRate is False " + m_DeclinationRate.ToString("0.00"));
                                break;
                            }
                    }
                }
            ...
            else
            {
                try
                {
                    if (settings.DisplayMethodCalls)
                        LogMsg("DeclinationRate Write", MessageLevel.msgComment, "About to set DeclinationRate property to 0.0");
                    telescopeDevice.DeclinationRate = 0.0d; // Set to a harmless value
                    LogMsg("DeclinationRate Write", MessageLevel.msgOK, m_DeclinationRate.ToString("0.00"));
                }
                catch (Exception ex)
                {
            ...
            if (g_InterfaceVersion > 1)
            {
                    ...
                    try
                    {
                        ...
                        switch (m_GuideRateDeclination)
                        {
                            case var case10 when case10 < 0.0d:
                                {
                                    LogMsg("GuideRateDeclination Read", MessageLevel.msgWarning, "GuideRateDeclination is < 0.0 " + m_GuideRateDeclination.ToString("0.00"));
                                    break;
                                }

                            default:
                                {
                                    LogMsg("GuideRateDeclination Read", MessageLevel.msgOK, m_GuideRateDeclination.ToString("0.00"));
                                    break;
                                }
                        }
                    }
                ...
                else
                {
                    ...
                    try // Write should definitely raise an error
                    {
                        ...
                        telescopeDevice.GuideRateDeclination = m_GuideRateDeclination;
                        LogMsg("GuideRateDeclination Write", MessageLevel.msgIssue, "CanSetGuideRates is false but no exception generated; value returned: " + m_GuideRateDeclination.ToString("0.00"));
                    }
            ...
            if (g_InterfaceVersion > 1)
            {
                    ...
                    try
                    {
                        ...
                        switch (m_GuideRateDeclination)
                        {
                            case var case12 when case12 < 0.0d:
                                {
                                    LogMsg("GuideRateRightAscension Read", MessageLevel.msgWarning, "GuideRateRightAscension is < 0.0 " + m_GuideRateRightAscension.ToString("0.00"));
                                    break;
                                }

                            default:
                                {
                                    LogMsg("GuideRateRightAscension Read", MessageLevel.msgOK, m_GuideRateRightAscension.ToString("0.00"));
                                    break;
                                }
                        }
                    }
                ...
                else
                {
                    ...
                    try // Write should definitely raise an error
                    {
                        ...
                        telescopeDevice.GuideRateRightAscension = m_GuideRateRightAscension;
                        LogMsg("GuideRateRightAscension Write", MessageLevel.msgIssue, "CanSetGuideRates is false but no exception generated; value returned: " + m_GuideRateRightAscension.ToString("0.00"));
                    }
                    catch (Exception ex) // Some other error so OK
                    {
            ...
            try
            {
                ...
                if (canSetRightAscensionRate) // Any value is acceptable
                {
                    switch (m_DeclinationRate)
                    {
                        case var case16 when case16 >= 0.0d:
                            {
                                LogMsg("RightAscensionRate Read", MessageLevel.msgOK, m_RightAscensionRate.ToString("0.00"));
                                break;
                            }

                        default:
                            {
                                LogMsg("RightAscensionRate Read", MessageLevel.msgWarning, "Negative RightAscensionRate: " + m_RightAscensionRate.ToString("0.00"));
                                break;
                            }
                    }
                }
                else // Only zero is acceptable
                {
                    switch (m_RightAscensionRate)
                    {
                        ...
                        default:
                            {
                                LogMsg("RightAscensionRate Read", MessageLevel.msgIssue, "RightAscensionRate is non zero when CanSetRightAscensionRate is False " + m_DeclinationRate.ToString("0.00"));
                                break;
                            }
                    }
                }
            ...
            else // V1 has no Can property so just test anyway, it is optional
            {
                try
                {
                    if (settings.DisplayMethodCalls)
                        LogMsg("RightAscensionRate Write", MessageLevel.msgComment, "About to set RightAscensionRate property to 0.00");
                    telescopeDevice.RightAscensionRate = 0.0d; // Set to a harmless value
                    LogMsg("RightAscensionRate Write", MessageLevel.msgOK, m_RightAscensionRate.ToString("0.00"));
                }
                catch (Exception ex)
                {
            ...
            catch (COMException ex)
            {
                ...
                else
                {
                    ...
                    LogMsg("SiteLatitude Write", MessageLevel.msgIssue, EX_COM + ex.Message + " " + ex.ErrorCode.ToString("X8"));
                }
            }
            catch (Exception ex)
            {
                        ...
                        try
                        {
                            ...
                            if (!telescopeDevice.AtPark) // OK We are unparked so check that no error is generated
                            {
                                ...
                                try
                                {
                                    ...
                                    {
                                        LogMsg("Park", MessageLevel.msgIssue, "Exception when calling Park two times in succession: " + ex.Message + " " + ex.ErrorCode.ToString("X8"));
                                    }
                                    catch (Exception ex)
                                    {
                                    ...
                                    if (canUnpark)
                                    {
                                        try
                                        {
                                            ...
                                            {
                                                LogMsg("UnPark", MessageLevel.msgIssue, "Exception when calling UnPark two times in succession: " + ex.Message + " " + ex.ErrorCode.ToString("X8"));
                                            }
                                            catch (Exception ex)
                                            {
                                        ...
                                        {
                                            LogMsg("UnPark", MessageLevel.msgError, EX_COM + ex.Message + " " + ex.ErrorCode.ToString("X8"));
                                        }
                                        catch (Exception ex)
                                        {
                                    ...
                                    else // Can't UnPark
                                    {
                                        ...
                                        catch (COMException ex)
                                        {
                                            ...
                                            {
                                                LogMsg("UnPark", MessageLevel.msgIssue, EX_COM + ex.Message + " " + ex.ErrorCode.ToString("X8"));
                                            }
                                        }
                                        ...
                                        {
                                            LogMsg("UnPark", MessageLevel.msgIssue, EX_NET + ex.Message);
                                        }
                                ...
                                {
                                    LogMsg("Park", MessageLevel.msgError, EX_COM + ex.Message + " " + ex.ErrorCode.ToString("X8"));
                                }
                                catch (Exception ex)
                                {
            ...
            try
            {
                ...
                switch (l_Rate)
                {
                    case var case1 when case1 > 10.0d:
                        {
                            LogMsg("Performance: " + p_Name, MessageLevel.msgInfo, "Transaction rate: " + l_Rate.ToString("0.0") + " per second");
                            break;
                        }
        ...
        private void TelescopeAxisRateTest(string p_Name, TelescopeAxis p_Axis)
        {
            ...
            try
            {
                ...
                switch (p_Axis)
                {
                    case TelescopeAxis.Primary:
                        {
                            if (settings.DisplayMethodCalls)
                                LogMsg(p_Name, MessageLevel.msgComment, "About to call AxisRates method, Axis: " + ((int)TelescopeAxis.Primary).ToString());
                    ...
                    case TelescopeAxis.Secondary:
                        {
                            if (settings.DisplayMethodCalls)
                                LogMsg(p_Name, MessageLevel.msgComment, "About to call AxisRates method, Axis: " + ((int)TelescopeAxis.Secondary).ToString());
                    ...
                    case TelescopeAxis.Tertiary:
                        {
                            if (settings.DisplayMethodCalls)
                                LogMsg(p_Name, MessageLevel.msgComment, "About to call AxisRates method, Axis: " + ((int)TelescopeAxis.Tertiary).ToString());
                ...
                {
                    LogMsg(p_Name + " Count", MessageLevel.msgError, EX_COM + ex.Message + " " + ex.ErrorCode.ToString("X8"));
                }
                catch (Exception ex)
                {
                ...
                {
                    LogMsg(p_Name + " Enum", MessageLevel.msgError, EX_COM + ex.Message + " " + ex.ErrorCode.ToString("X8"));
                }
                catch (Exception ex)
                {
                ...
                if (Operators.ConditionalCompareObjectGreater(l_AxisRates.Count, 0, false))
                {
                    ...
                    {
                        LogMsg(p_Name, MessageLevel.msgError, "COM Unable to read AxisRates object - Exception: " + ex.Message + " " + ex.ErrorCode.ToString("X8"));
                        LogMsg(p_Name, MessageLevel.msgDebug, "COM Unable to read AxisRates object - Exception: " + ex.ToString());
                    }
                    catch (DriverException ex)
                    {
                        LogMsg(p_Name, MessageLevel.msgError, ".NET Unable to read AxisRates object - Exception: " + ex.Message + " " + ex.Number.ToString("X8"));
            ...
            {
                LogMsg(p_Name, MessageLevel.msgError, "COM Unable to get an AxisRates object - Exception: " + ex.Message + " " + ex.ErrorCode.ToString("X8"));
            }
            catch (DriverException ex)
            {
                LogMsg(p_Name, MessageLevel.msgError, ".NET Unable to get an AxisRates object - Exception: " + ex.Message + " " + ex.Number.ToString("X8"));
            }
            ...
            try
            {
                switch (p_Type)
                {
                    ...
                    case RequiredMethodType.tstCanMoveAxisPrimary:
                        {
                            if (settings.DisplayMethodCalls)
                                LogMsg(p_Name, MessageLevel.msgComment, "About to call CanMoveAxis method " + ((int)TelescopeAxis.Primary).ToString());
                    ...
                    case RequiredMethodType.tstCanMoveAxisSecondary:
                        {
                            if (settings.DisplayMethodCalls)
                                LogMsg(p_Name, MessageLevel.msgComment, "About to call CanMoveAxis method " + ((int)TelescopeAxis.Secondary).ToString());
                    ...
                    case RequiredMethodType.tstCanMoveAxisTertiary:
                        {
                            if (settings.DisplayMethodCalls)
                                LogMsg(p_Name, MessageLevel.msgComment, "About to call CanMoveAxis method " + ((int)TelescopeAxis.Tertiary).ToString());
            ...
            if (p_CanTest) // Confirm that an error is raised if the optional command is not implemented
            {
                try
                {
                        ...
                        case OptionalMethodType.MoveAxisPrimary:
                            {
                                ...
                                if (settings.DisplayMethodCalls)
                                    LogMsg(p_Name, MessageLevel.msgComment, "About to call AxisRates method for axis " + ((int)TelescopeAxis.Primary).ToString());
                                l_AxisRates = telescopeDevice.AxisRates(TelescopeAxis.Primary);
                        ...
                        case OptionalMethodType.PulseGuide:
                            {
                                ...
                                else // OK to test pulse guiding
                                {
                                    ...
                                    m_StartTime = DateTime.Now;
                                    if (settings.DisplayMethodCalls)
                                        LogMsg(p_Name, MessageLevel.msgComment, "About to call PulseGuide method, Direction: " + ((int)GuideDirection.East).ToString() + ", Duration: " + PULSEGUIDE_MOVEMENT_TIME * 1000 + "ms");
                                        ...
                                        case PointingState.Normal: // We are on pierEast so try pierWest
                                            {
                                                try
                                                {
                                                    ...
                                                    if (settings.DisplayMethodCalls)
                                                        LogMsg(p_Name, MessageLevel.msgComment, "About to set SideOfPier property to " + ((int)PointingState.ThroughThePole).ToString());
                                        ...
                                        case PointingState.ThroughThePole: // We are on pierWest so try pierEast
                                            {
                                                try
                                                {
                                                    ...
                                                    if (settings.DisplayMethodCalls)
                                                        LogMsg(p_Name, MessageLevel.msgComment, "About to set SideOfPier property to " + ((int)PointingState.Normal).ToString());
                    ...
                    if (l_AxisRates is object)
                    {
                        try
                        {
                            if (settings.DisplayMethodCalls) LogMsg(p_Name, MessageLevel.msgComment, "About to dispose of AxisRates object");
                            l_AxisRates.Dispose();
                ...
                try
                {
                    switch (p_Type)
                    {
                        ...
                        case OptionalMethodType.MoveAxisPrimary:
                            {
                                if (settings.DisplayMethodCalls)
                                    LogMsg(p_Name, MessageLevel.msgComment, "About to call MoveAxis method for axis " + ((int)TelescopeAxis.Primary).ToString() + " at speed 0");
                                telescopeDevice.MoveAxis(TelescopeAxis.Primary, 0.0d);
                                break;
                            }
                        ...
                        case OptionalMethodType.MoveAxisSecondary:
                            {
                                if (settings.DisplayMethodCalls)
                                    LogMsg(p_Name, MessageLevel.msgComment, "About to call MoveAxis method for axis " + ((int)TelescopeAxis.Secondary).ToString() + " at speed 0");
                                telescopeDevice.MoveAxis(TelescopeAxis.Secondary, 0.0d);
                                break;
                            }
                        ...
                        case OptionalMethodType.MoveAxisTertiary:
                            {
                                if (settings.DisplayMethodCalls)
                                    LogMsg(p_Name, MessageLevel.msgComment, "About to call MoveAxis method for axis " + ((int)TelescopeAxis.Tertiary).ToString() + " at speed 0");
                                telescopeDevice.MoveAxis(TelescopeAxis.Tertiary, 0.0d);
                                break;
                            }
                        ...
                        case OptionalMethodType.PulseGuide:
                            {
                                if (settings.DisplayMethodCalls)
                                    LogMsg(p_Name, MessageLevel.msgComment, "About to call PulseGuide method, Direction: " + ((int)GuideDirection.East).ToString() + ", Duration: 0ms");
                                telescopeDevice.PulseGuide(GuideDirection.East, 0);
                                break;
                            }
        ...
        private void TelescopeMoveAxisTest(string p_Name, TelescopeAxis p_Axis, IAxisRates p_AxisRates)
        {
            ...
            if (Operators.ConditionalCompareObjectGreater(p_AxisRates.Count, 0, false))
            {
                ...
                if (l_RateMinimum != double.PositiveInfinity & l_RateMaximum != double.NegativeInfinity) // Found valid rates
                {
                    ...
                    {
                        LogMsg(p_Name, MessageLevel.msgError, "Unable to set a movement rate of zero - " + ex.Message + " " + ex.ErrorCode.ToString("X8"));
                    }
                    catch (DriverException ex)
                    {
                        LogMsg(p_Name, MessageLevel.msgError, "Unable to set a movement rate of zero - " + ex.Message + " " + ex.Number.ToString("X8"));
                    }
                    catch (Exception ex)
                    {
        ...
        private void SideOfPierTests()
        {
            ...
            LogMsg("SideofPier", MessageLevel.msgInfo, "Reported SideofPier at HA -9, +9: " + TranslatePierSide((PointingState)l_PierSideMinus9.SideOfPier, false) + TranslatePierSide((PointingState)l_PierSidePlus9.SideOfPier, false));
            LogMsg("SideofPier", MessageLevel.msgInfo, "Reported SideofPier at HA -3, +3: " + TranslatePierSide((PointingState)l_PierSideMinus3.SideOfPier, false) + TranslatePierSide((PointingState)l_PierSidePlus3.SideOfPier, false));
            ...
            LogMsg("DestinationSideofPier", MessageLevel.msgInfo, "Reported DesintationSideofPier at HA -9, +9: " + TranslatePierSide((PointingState)l_PierSideMinus9.DestinationSideOfPier, false) + TranslatePierSide((PointingState)l_PierSidePlus9.DestinationSideOfPier, false));
            LogMsg("DestinationSideofPier", MessageLevel.msgInfo, "Reported DesintationSideofPier at HA -3, +3: " + TranslatePierSide((PointingState)l_PierSideMinus3.DestinationSideOfPier, false) + TranslatePierSide((PointingState)l_PierSidePlus3.DestinationSideOfPier, false));
        ...
        public SideOfPierResults SOPPierTest(double p_RA, double p_DEC, string p_Msg)
        {
            ...
            try
            {
                ...
                LogMsg("SOPPierTest", MessageLevel.msgDebug, "Testing RA DEC: " + FormatRA(p_RA) + " " + FormatDec(p_DEC) + " Current pierSide: " + TranslatePierSide((PointingState)telescopeDevice.SideOfPier, true));
                try
                {
                            ...
                            case Axis.RA:
                                {
                                    ...
                                    else
                                    {
                                        if (m_Slewing & m_RightAscensionRate == Rate)
                                            LogMsg(TestName, MessageLevel.msgError, $"RightAscensionRate was successfully set to {Rate} but Slewing is returning True, it should return False.");
                                        if (m_Slewing & m_RightAscensionRate != Rate)
                                            LogMsg(TestName, MessageLevel.msgError, $"RightAscensionRate Read does not return {Rate} as set, instead it returns {m_RightAscensionRate}. Slewing is also returning True, it should return False.");
                                        if (!m_Slewing & m_RightAscensionRate != Rate)
                                            LogMsg(TestName, MessageLevel.msgError, $"RightAscensionRate Read does not return {Rate} as set, instead it returns {m_RightAscensionRate}.");
                                    }
                            ...
                            case Axis.Dec:
                                {
                                    ...
                                    else
                                    {
                                        if (m_Slewing & m_DeclinationRate == Rate)
                                            LogMsg(TestName, MessageLevel.msgError, $"DeclinationRate was successfully set to {Rate} but Slewing is returning True, it should return False.");
                                        if (m_Slewing & m_DeclinationRate != Rate)

...
dotnet publish ConformU/ConformU.csproj -c Debug -p:Platform="Any CPU" -r osx-x64 --framework net10.0 --self-contained true /p:PublishTrimmed=false -p:PublishSingleFile=true /p:UseAppHost=true
bsdtar -cJf publish/conformu.macos-x64.tar.xz -C "ConformU\bin\Any CPU\Debug\net10.0\osx-x64\publish" .
echo *** Completed MacOS Intel silicon

echo *** Publishing MacOS Apple silicon
dotnet publish ConformU/ConformU.csproj -c Debug -p:Platform="Any CPU" -r osx-arm64 --framework net10.0 --self-contained true /p:PublishTrimmed=false -p:PublishSingleFile=true /p:UseAppHost=true
bsdtar -cJf publish/conformu.macos-arm64.tar.xz -C "ConformU\bin\Any CPU\Debug\net10.0\osx-arm64\publish" .
echo *** Completed MacOS Apple silicon

echo *** Publishing Linux ARM32
dotnet publish ConformU/ConformU.csproj -c Debug /p:Platform="Any CPU" -r linux-arm --framework net10.0 --self-contained true /p:PublishTrimmed=false /p:PublishSingleFile=true /p:UseAppHost=true /p:PublishReadyToRun=true

bsdtar -cJf publish/conformu.linux-arm32.needsexec.tar.xz -C "ConformU\bin\Any CPU\Debug\net10.0\linux-arm\publish" .
echo *** Completed Linux ARM32

echo *** Publishing Linux ARM64
dotnet publish ConformU/ConformU.csproj -c Debug /p:Platform="Any CPU" -r linux-arm64 --framework net10.0 --self-contained true /p:PublishTrimmed=false /p:PublishSingleFile=true /p:UseAppHost=true /p:PublishReadyToRun=true
bsdtar -cJf publish/conformu.linux-arm64.needsexec.tar.xz -C "ConformU\bin\Any CPU\Debug\net10.0\linux-arm64\publish" .
